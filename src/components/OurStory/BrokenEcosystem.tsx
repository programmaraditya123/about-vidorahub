      ...
      <div className=" z-10 max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
        ...
        <div>
          ...
          <p className="text-gray-400 leading-relaxed mb-8">
            For years, Indian creators have been at the mercy of opaque,
            global algorithms that prioritize retention over quality, and
            engagement over community. The dream of creator ownership was
            fading.
          </p>

          {/* Warning Box */}
          <div className="rounded-xl border border-red-500/20 bg-red-500/5 p-6 space-y-3">
            <Bullet text="Shadow-banning without transparency" />
            <Bullet text="Unfair revenue splits favoring the house" />
            <Bullet text="Loss of direct audience relationship" />
          </div>
        </div>

        {/* RIGHT CARD */}
        <div className="">
          <div className="rounded-xl border border-white/10 bg-[#020617] p-12 h-[320px] flex items-center justify-center text-center overflow-hidden">
